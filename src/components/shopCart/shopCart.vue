<template>
  <div>
      ...
      <div class="content">
        <div class="content-left" @click="toggleShow">
          <div class="logo-wrapper ">
            <div class="logo" :class="{highlight: totalPrice}">
              <i class="iconfont icon-gouwuche " :class="{highlight: totalPrice}"></i>
            </div>
        ...
        <div class="content-right">
          <div class="pay not-enough"
               :class="{'not-enough': this.totalPrice < this.info.minPrice, enough: this.totalPrice >= this.info.minPrice }">
            {{payMessage}}
          </div>
        </div>
      </div>
    ...
    <transition name="fade">
      <div class="list-mask" v-if="Show" @click="toggleShow"></div>
    </transition>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    payMessage () {
      if (!this.totalPrice) {
        return `最低${this.info.minPrice}元起送`
